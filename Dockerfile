...
RUN apk --update add apache2 php7-apache2 curl php7-curl php7-json  php7-openssl php7-xml php7-gd php7-xdebug php7-session php7-pdo_pgsql php7-pdo_mysql php7-mbstring
